if (!((jsf && jsf.specversion && jsf.specversion >= 23000) && (jsf.implversion && jsf.implversion >= 3))) {
    var jsf = {};
    jsf.ajax = function() {
        var eventListeners = [];
        var errorListeners = [];
        ...
        var getFormsToUpdate = function getFormsToUpdate(context) {
            ...
            var add = function(element) {
                if (element) {
                    if (element.nodeName && element.nodeName.toLowerCase() == "form" && element.method == "post" && element.id && element.elements && element.id.indexOf(context.namingContainerPrefix) == 0) {
        ...
        var AjaxEngine = function AjaxEngine(context) {
            ...
            req.context.namingContainerId = null;
            req.context.namingContainerPrefix = null;
            req.xmlReq = null;
            req.async = true;
            req.parameters = {};
    ...
    jsf.getViewState = function(b) {
        ...
        var a = function(m, n) {
            ...
            j += encodeURIComponent(m) + "=" + encodeURIComponent(n);
            k.push(j)
        };
        for (var f = 0; f < g; f++) {
            var c = d[f];
    ...
    jsf.getClientWindow = function(d) {
        ...
        var f = function(m) {
            ...
            if (!m.tagName) {
                ...
                if (m.tagName.toLowerCase() == b) {
                    o.push(m);
                    return o
                }
            }
            if (m.querySelectorAll) {
                return m.querySelectorAll(b)
            }
            for (var n = m.childNodes.length - 1; n >= 0; n--) {
                var p = m.childNodes[n];
                o = o.concat(f(p, b))
            }
            return o
        };
    ...
    jsf.push = function() {
        ...
        function b(h, n, r, m, q, k) {
            ...
            p.open = function() {
                ...
                o.onclose = function(s) {
                    if (!o || (s.code == 1000 && s.reason == g) || (s.code == 1008) || (j == null) || (j >= a)) {
                        q(s.code, n, s)
                    } else {
                        setTimeout(p.open, e * j++)
                    }
                }
            };
            p.close = function() {
        ...
        function d(h) {
            return (typeof h !== "function") && (h = window[h] || function() {}), h
        }
        function f(h) {
            var j = c[h];
            if (j) {
                ...
                throw new Error("Unknown clientId: " + h)
            }
        }
        return {
            init: function(j, m, p, n, q, o, h, k) {
                o = d(o);
                if (!window.WebSocket) {
                    o(-1, j);
                    return
