!function(a) {
    ...
    function y(a, b, d) {
        ...
        f && 8 > g && (e.gutters.style.zIndex = -1, e.scroller.style.paddingRight = 0),
    ...
    function B(a) {
        a.options.lineWrapping ? (Cg(a.display.wrapper, "CodeMirror-wrap"), a.display.sizer.style.minWidth = "", a.display.sizerWidth = null) : (Bg(a.display.wrapper, "CodeMirror-wrap"), J(a)),
        D(a),
        lc(a),
        Ib(a),
        setTimeout(function() {
    ...
    function N() {}
    function O(a) {
        a.display.scrollbars && (a.display.scrollbars.clear(), a.display.scrollbars.addClass && Bg(a.display.wrapper, a.display.scrollbars.addClass)),
    ...
    function da(a, b, c) {
        ...
        for (var d = a.display, e = a.options.lineNumbers, f = d.lineDiv, g = f.firstChild, j = d.view, k = d.viewFrom, l = 0; l < j.length; l++) {
            ...
            if (m.hidden)
                ...
                m.changes && (ig(m.changes, "gutter") > -1 && (o = !1), ea(a, m, k, c)),
                o && (wg(m.lineNumber), m.lineNumber.appendChild(document.createTextNode(U(a.options, k)))),
    ...
    function ia(a, b) {
        ...
        b.text = d.pre,
        d.bgClass != b.bgClass || d.textClass != b.textClass ? (b.bgClass = d.bgClass, b.textClass = d.textClass, ja(b)) : c && (b.text.className = c)
    }
    function ja(a) {
        ga(a),
    ...
    function Ja(a, b, c, d, e) {
        ...
        function j(b) {
            if (1 == b.nodeType) {
                ...
                if (null != c)
                    return "" == c && (c = b.textContent.replace(/\u200b/g, "")), void (f += c);
                var l,
        ...
        for (var f = "", g = !1, h = a.doc.lineSeparator(); j(b), b != c;)
            b = b.nextSibling;
        return f
    }
    function Ka(a, b) {
            ...
            for (var g = 0; g < f.markedSpans.length; ++g) {
                ...
                if ((null == h.from || (i.inclusiveLeft ? h.from <= b.ch : h.from < b.ch)) && (null == h.to || (i.inclusiveRight ? h.to >= b.ch : h.to > b.ch))) {
                    ...
                    if (c) {
                        var k,
                            j = i.find(0 > d ? 1 : -1);
                        if ((0 > d ? i.inclusiveRight : i.inclusiveLeft) && (j = fb(a, j, -d, f)), j && j.line == b.line && (k = ra(j, c)) && (0 > d ? 0 > k : k > 0))
                            return db(a, j, b, d, e)
                    }
    ...
    function jb(a, b, c) {
        ...
        function k(b, c, d) {
            ...
            return Tg(qf(f), c || 0, null == d ? g : d, function(a, b, e) {
                ...
                null == c && 0 == a && (o = h),
                n.top - f.top > 3 && (j(o, f.top, null, f.bottom), o = h, f.bottom < n.top && j(o, f.bottom, null, n.top)),
                null == d && b == g && (p = i),
        ...
        if (l.line == m.line)
            ...
            p && (q.top < r.top - 2 ? (j(q.right, q.top, null, q.bottom), j(h, r.top, r.left, r.bottom)) : j(q.right, q.top, r.left - q.right, q.bottom)),
    ...
    function Ab(a, b) {
        var c = nf(b),
            d = zb(a, c);
        d && !d.text ? d = null : d && d.changes && (ea(a, d, c, ca(a)), a.curOp.forceUpdate = !0),
        d || (d = xb(a, b));
        var e = wb(d, b, c);
        return {
            line: b,
    ...
    function cc(a) {
        ...
        a.barMeasure = L(b),
        c.maxLineChanged && !b.options.lineWrapping && (a.adjustWidthTo = yb(b, c.maxLine, c.maxLine.text.length).left + 3, b.display.sizerWidth = a.adjustWidthTo, a.barMeasure.scrollWidth = Math.max(c.scroller.clientWidth, c.sizer.offsetLeft + a.adjustWidthTo + sb(b) + b.display.barWidth), a.maxScrollLeft = Math.max(0, c.sizer.offsetLeft + a.adjustWidthTo - tb(b))),
        (a.updatedDisplay || a.selectionChanged) && (a.preparedSelection = c.input.prepareSelection())
    }
    function dc(a) {
        var b = a.cm;
        null != a.adjustWidthTo && (b.display.sizer.style.minWidth = a.adjustWidthTo + "px", a.maxScrollLeft < b.doc.scrollLeft && Lc(b, Math.min(b.display.scroller.scrollLeft, a.maxScrollLeft), !0), b.display.maxLineChanged = !1),
    ...
    function lc(a, b, c, d) {
        ...
        if (d && c < e.viewTo && (null == e.updateLineNumbers || e.updateLineNumbers > b) && (e.updateLineNumbers = b), a.curOp.viewChanged = !0, b >= e.viewTo)
            ...
            w && ye(a.doc, c + d) > e.viewFrom ? nc(a) : (e.viewFrom += d, e.viewTo += d);
    ...
    function qc(a, b, c) {
        var d = a.display,
            e = d.view;
        0 == e.length || b >= d.viewTo || c <= d.viewFrom ? (d.view = kc(a, b, c), d.viewFrom = b) : (d.viewFrom > b ? d.view = kc(a, b, d.viewFrom).concat(d.view) : d.viewFrom < b && (d.view = d.view.slice(oc(a, b))), d.viewFrom = b, d.viewTo < c ? d.view = d.view.concat(kc(a, d.viewTo, c)) : d.viewTo > c && (d.view = d.view.slice(0, oc(a, c)))),
        d.viewTo = c
    }
    function rc(a) {
    ...
    function sc(a) {
        ...
        Mf(b.scroller, "touchend", function(c) {
            ...
            if (d && !vc(b, c) && null != d.left && !d.moved && new Date - d.start < 300) {
                var g,
                    f = a.coordsChar(b.activeTouch, "page");
    ...
    function xc(a) {
        ...
        if (!(Uf(b, a) || c.activeTouch && c.input.supportsTouch())) {
            if (c.shift = a.shiftKey, vc(c, a))
                return void (h || (c.scroller.draggable = !1, setTimeout(function() {
    ...
    function Bc(a, b, c, d) {
        var e = a.display,
            ...
            j = gc(a, function(k) {
                ...
                Math.abs(b.clientX - k.clientX) + Math.abs(b.clientY - k.clientY) < 10 && (Gf(k), !d && +new Date - 200 < i && Ua(a.doc, c), h || f && 9 == g ? setTimeout(function() {
                    document.body.focus(),
                    e.input.focus()
                }, 20) : e.input.focus())
            });
    ...
    function Cc(a, b, c, d, e) {
        ...
        var h,
            ...
            j = g.sel,
            k = j.ranges;
        if (e && !b.shiftKey ? (i = g.sel.contains(c), h = i > -1 ? k[i] : new La(c, c)) : (h = g.sel.primary(), i = g.sel.primIndex), b.altKey)
            d = "rect",
            e || (h = new La(c, c)),
            c = wc(a, b, !0, !0),
            i = -1;
    ...
    function Hc(a, b) {
        ...
        if (!Uf(a, b) && !vc(a.display, b) && (b.dataTransfer.setData("Text", a.getSelection()), b.dataTransfer.setDragImage && !l)) {
            ...
            k && (c.width = c.height = 1, a.display.wrapper.appendChild(c), c._top = c.offsetTop),
    ...
    function Ic(a, b) {
        ...
        if (c) {
            ...
            ib(a, c, d),
            a.display.dragCursor || (a.display.dragCursor = ug("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), a.display.lineSpace.insertBefore(a.display.dragCursor, a.display.cursorDiv)),
    ...
    function Pc(a, b) {
        ...
        if (e && j || f && l) {
            if (f && q && h)
                a:
                for (var m = b.target, n = g.view; m != i; m = m.parentNode)
            ...
            if (e && !c && !k && null != Nc)
                return f && l && Kc(a, Math.max(0, Math.min(i.scrollTop + f * Nc, i.scrollHeight - i.clientHeight))), Lc(a, Math.max(0, Math.min(i.scrollLeft + e * Nc, i.scrollWidth - i.clientWidth))), (!f || f && l) && Gf(b), void (g.wheelStartX = null);
            if (f && null != Nc) {
                var p = f * Nc,
                    r = a.doc.scrollTop,
            ...
            20 > Mc && (null == g.wheelStartX ? (g.wheelStartX = i.scrollLeft, g.wheelStartY = i.scrollTop, g.wheelDX = e, g.wheelDY = f, setTimeout(function() {
                if (null != g.wheelStartX) {
                    ...
                    c && (Nc = (Nc * Mc + c) / (Mc + 1), ++Mc)
                }
            }, 200)) : (g.wheelDX += e, g.wheelDY += f))
        }
    }
    function Qc(a, b, c) {
        if ("string" == typeof b && (b = Od[b], !b))
            return !1;
    ...
    function Xc(a) {
        ...
        if (b.curOp.focus = zg(), !Uf(b, a)) {
            ...
            var d = Uc(b, a);
            k && (Wc = d ? c : null, !d && 88 == c && !Pg && (q ? a.metaKey : a.ctrlKey) && b.replaceSelection("", null, "cut")),
    ...
    function ad(a) {
        ...
        "nocursor" != a.options.readOnly && (a.state.focused || (Qf(a, "focus", a), a.state.focused = !0, Cg(a.display.wrapper, "CodeMirror-focused"), a.curOp || a.display.selForContextMenu == a.doc.sel || (a.display.input.reset(), h && setTimeout(function() {
    ...
    function ld(a, b) {
        if (1 != b.text.length || "" != b.text[0] || 0 != ra(b.from, b.to)) {
            ...
            var d = [];
            gf(a, function(a, c) {
                c || -1 != ig(d, a.history) || (Ff(a.history, b), d.push(a.history)),
                od(a, b, null, ie(a, b))
            })
        }
    }
        ...
        if (!a.cm || !a.cm.state.suppressEdits) {
            ...
            if (i != g.length) {
                ...
                for (var k = Wf(a, "beforeChange") || a.cm && Wf(a.cm, "beforeChange"), i = e.changes.length - 1; i >= 0; --i) {
                    ...
                    var n = [];
                    gf(a, function(a, b) {
                        b || -1 != ig(n, a.history) || (Ff(a.history, l), n.push(a.history)),
                        od(a, l, null, ke(a, l))
                    })
                }
            }
    ...
    function sd(a, b, c, d) {
        ...
        for (var e = 0; 5 > e; e++) {
            var f = !1,
                ...
                j = a.doc.scrollTop,
                k = a.doc.scrollLeft;
            if (null != i.scrollTop && (Kc(a, i.scrollTop), Math.abs(a.doc.scrollTop - j) > 1 && (f = !0)), null != i.scrollLeft && (Lc(a, i.scrollLeft), Math.abs(a.doc.scrollLeft - k) > 1 && (f = !0)), !f)
                break
        }
        return g
    }
    ...
    function wd(a) {
        ...
        var b = a.getCursor(),
            c = b,
            d = b;
        a.options.lineWrapping || (c = b.ch ? qa(b.line, b.ch - 1) : b, d = qa(b.line, b.ch + 1)),
        a.curOp.scrollToPos = {
            from: c,
            to: d,
    ...
    function yd(a, b, c, d) {
        ...
        if (a.options.indentWithTabs)
            for (var n = Math.floor(k / g); n; --n)
                ...
                l += "	";
        if (k > m && (l += fg(k - m)), l != j)
            return qd(e, l, qa(b, 0), qa(b, j.length), "+input"), h.stateAfter = null, !0;
    ...
    function Yd(a, b, c, d, e) {
        ...
        var f = new Xd(a, e),
            g = ra(b, c);
        if (d && mg(d, f, !1), g > 0 || 0 == g && f.clearWhenEmpty !== !1)
            return f;
    ...
    function Ae(a, b, c) {
        ...
        for (var e, f = 0; f < b.markedSpans.length; ++f)
            if (e = b.markedSpans[f], e.marker.collapsed && !e.marker.widgetNode && e.from == c.to && (null == e.to || e.to != c.from) && (e.marker.inclusiveLeft || c.marker.inclusiveRight) && Ae(a, b, e))
                return !0
    }
    function Ce(a, b, c) {
    ...
    function Pe(a, b, c, d) {
        ...
        for (f.start = f.pos = d || 0, "" == b && Je(e, c); !f.eol();)
            Ke(e, f, c),
            f.start = f.pos
    }
    function Se(a, b) {
    ...
    function Te(a, b) {
        ...
        for (var e = 0; e <= (b.rest ? b.rest.length : 0); e++) {
            ...
            Ze(g, d, Oe(a, g, j)),
            g.styleClasses && (g.styleClasses.bgClass && (d.bgClass = Dg(g.styleClasses.bgClass, d.bgClass || "")), g.styleClasses.textClass && (d.textClass = Dg(g.styleClasses.textClass, d.textClass || ""))),
                ...
                if (m == i) {
                    ...
                    if (!r || r.from == i)
                        for (var u = 0; u < s.length; ++u)
                            Ye(b, 0, s[u]);
                    if (r && (r.from || 0) == i) {
                        if (Ye(b, (null == r.to ? h + 1 : r.to) - i, r.marker, null == r.from), null == r.to)
                            return;
                        r.to == i && (r = !1)
                    }
                }
            ...
            if (f.ranges)
                ...
                for (var i = 0; i < g.length; ++i) {
                    ...
                    if (h.push({
                        ...
                        for (var l in j)
                            (k = l.match(/^spans_(\d+)$/)) && ig(b, Number(k[1])) > -1 && (gg(h)[l] = j[l], delete j[l])
                }
            }
        }
        return e
    ...
    function bh(a, b) {
        ...
        for (var d, c = 0; c < a.length; ++c) {
            ...
            if (e.from == b || e.to == b) {
                if (null != d)
                    return _g(a, e.level, a[d].level) ? (e.from != e.to && (ah = d), c) : (e.from != e.to && (ah = c), d);
                d = c
            }
        }
        return d
    ...
    function dh(a, b, c, d) {
        ...
        for (var f = bh(e, b), g = e[f], h = ch(a, b, g.level % 2 ? -c : c, d);;) {
            if (h > g.from && h < g.to)
                return h;
            if (h == g.from || h == g.to)
                return bh(e, h) == f ? h : (g = e[f += c], c > 0 == g.level % 2 ? g.to : g.from);
            if (g = e[f += c], !g)
                return null;
    ...
    Ca.prototype = mg({
            ...
            function h(a) {
                if (!Uf(c, a)) {
                    if (c.somethingSelected())
                        ...
                        var d = Aa(c);
                        wa = d.text,
                        "cut" == a.type ? c.setSelections(d.ranges, null, $f) : (b.prevInput = "", e.value = d.text.join("\n"), hg(e))
                    }
        ...
        reset: function(a) {
            if (!this.contextMenuPending) {
                ...
                if (d.somethingSelected()) {
                    ...
                    a || (this.prevInput = this.textarea.value = "", f && g >= 9 && (this.hasSelection = null));
        ...
        poll: function() {
            ...
            return fc(a, function() {
                ...
                j.composing && (j.composing.range.clear(), j.composing.range = a.markText(j.composing.start, a.getCursor("to"), {
                    className: "CodeMirror-composing"
                }))
            }), !0
        },
        ...
        onContextMenu: function(a) {
            ...
            if (i && !k) {
                ...
                if (b.wrapper.style.position = "absolute", e.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (a.clientY - 5) + "px; left: " + (a.clientX - 5) + "px; z-index: 1000; background: " + (f ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", h)
        ...
        showPrimarySelection: function() {
            ...
            if (!d || d.bad || !e || e.bad || 0 != ra(ua(d, e), b.from()) || 0 != ra(ta(d, e), b.to())) {
                ...
                if (f || g) {
                    ...
                    l && (!c && this.cm.state.focused ? (a.collapse(f.node, f.offset), l.collapsed || a.addRange(l)) : (a.removeAllRanges(), a.addRange(l)), i && null == a.anchorNode ? a.addRange(i) : c && this.startGracePeriod()),
    ...
    x.prototype = {
        ...
        removeOverlay: hc(function(a) {
            for (var b = this.state.overlays, c = 0; c < b.length; ++c) {
                ...
                if (d == a || "string" == typeof a && d.name == a)
                    return b.splice(c, 1), this.state.modeGen++, void lc(this)
            }
        }),
        ...
        indentSelection: hc(function(a) {
            for (var b = this.doc.sel.ranges, c = -1, d = 0; d < b.length; d++) {
                var e = b[d];
                if (e.empty())
                    e.head.line > c && (yd(this, e.head.line, a, !0), c = e.head.line, d == this.doc.sel.primIndex && wd(this));
                else {
                    var f = e.from(),
                        g = e.to(),
                        h = Math.max(c, f.line);
        ...
        heightAtLine: function(a, b) {
            ...
            if ("number" == typeof a) {
                ...
                a < this.doc.first ? a = this.doc.first : a > e && (a = e, c = !0),
                d = jf(this.doc, a)
            } else
                d = a;
            return Lb(this, d, {
        ...
        clearGutter: hc(function(a) {
            var b = this,
                ...
                d = c.first;
            c.iter(function(c) {
                c.gutterMarkers && c.gutterMarkers[a] && (c.gutterMarkers[a] = null, mc(b, d, "gutter"), rg(c.gutterMarkers) && (c.gutterMarkers = null)),
                ++d
            })
        }),
        lineInfo: function(a) {
        ...
        findPosV: function(a, b, c, d) {
            ...
            for (var g = 0, h = Pa(this.doc, a); b > g; ++g) {
                var i = Ob(this, h, "div");
                if (null == f ? f = i.left : i.left = f, h = Cd(this, i, e, c), h.hitSide)
                    break
            }
            return h
        },
    ...
    Fd("readOnly", !1, function(a, b) {
        "nocursor" == b ? (bd(a), a.display.input.blur(), a.display.disabled = !0) : a.display.disabled = !1,
            ...
            transposeChars: function(a) {
                fc(a, function() {
                    for (var b = a.listSelections(), c = [], d = 0; d < b.length; d++) {
                        ...
                        if (f)
                            if (e.ch == f.length && (e = new qa(e.line, e.ch - 1)), e.ch > 0)
    ...
    x.fromTextArea = function(a, b) {
        ...
        b.finishInit = function(b) {
            ...
            b.toTextArea = function() {
                ...
                a.style.display = "",
                a.form && (Pf(a.form, "submit", d), "function" == typeof a.form.submit && (a.form.submit = f))
            }
        },
    ...
    Xd.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            for (var d = null, e = null, f = 0; f < this.lines.length; ++f) {
                ...
                a && !this.collapsed ? mc(a, nf(g), "text") : a && (null != h.to && (e = nf(g)), null != h.from && (d = nf(g))),
            ...
            this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, a && bb(a.doc)),
    ...
    Xd.prototype.find = function(a, b) {
        ...
        for (var c, d, e = 0; e < this.lines.length; ++e) {
            ...
            if (null != g.from && (c = qa(b ? f : nf(f), g.from), -1 == a))
                return c;
            if (null != g.to && (d = qa(b ? f : nf(f), g.to), 1 == a))
                return d
        }
        return c && {
                from: c,
    ...
    var yg = x.contains = function(a, b) {
        if (3 == b.nodeType && (b = b.parentNode), a.contains)
            return a.contains(b);
        do if (11 == b.nodeType && (b = b.host), b == a)
            return !0;
